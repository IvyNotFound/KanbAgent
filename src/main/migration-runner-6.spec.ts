...
describe('migrateDb — exact return value', () => {
  ...
  it('returns 9 when nine migrations are pending (v33, v34, v35, v36, v37, v38, v39, v40, v41)', () => {
    const db = makeMockDb({
      userVersion: 32,
  ...
  it('returns 14 when fourteen migrations are pending (v28–v41)', () => {
    const db = makeMockDb({ userVersion: 27, colMap: { agents: ['id', 'name'], sessions: ['id', 'status'] } })
    const result = migrateDb(db as unknown as import('./migration-db-adapter').MigrationDb)
    expect(result).toBe(14) // v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41
  })
  ...
  it('returns 16 for genuine legacy bootstrap (v0 + config + permission_mode + max_sessions = runs v24..v39)', () => {
    const db = makeMockDb({
      userVersion: 0,
      hasConfigTable: true,
      colMap: {
    ...
    const result = migrateDb(db as unknown as import('./migration-db-adapter').MigrationDb)
    expect(result).toBe(18) // v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41
    expect(result).not.toBe(16)
    expect(result).not.toBe(19)
  })
